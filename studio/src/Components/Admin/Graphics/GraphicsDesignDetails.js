...
function GraphicsDesignDetails() {
    ...
    return (
        <div className="App text-center">
            ...
            <div className="h-100 align-items-center d-flex justify-content-center">
                <div className="col-md-4 text-left card pt-4 pb-2 pl-3 pr-3 mb-5">
                    ...
                    <form className="form">
                        ...
                        <div className="mb-3">
                            ...
                            <input type="text" className="form-control" placeholder="Design Type" value={name}
                                disabled />
                        </div>
                        ...
                        <div className="mb-3">
                            ...
                            <input type="text" className="form-control" placeholder="Client Name" value={number}
                                disabled />
                        </div>

                        <div className="mb-3">
                            <label>Phone Number</label>
                            <input type="text" className="form-control" placeholder="Phone Number" value={description}
                                disabled />
                        </div>

                        <div className="mb-3">
                            <label>Other Details</label>
                            <textarea className="form-control" rows="3" placeholder="Other Details" value={type}
                                disabled></textarea>
                        </div>

                        <div className="mb-3">
                            <a href="#" id="image" className="form-control">Download Image</a>
                        </div>
