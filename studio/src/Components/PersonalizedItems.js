            ...
            <div className="container h-100 align-items-center pt-3 justify-content-center">
                ...
                <div class="shop-items">
                    ...
                    <div className="p-3 bg-dark text-white d-flex justify-content-between">
                        <input onChange={searchValue} type="text" className="form-control align-left w-25 p-3" placeholder="Search Item" />
                        <h3 className="lead text-uppercase">Personalized Items</h3>
                        ...
                        <div class="row bg-white">

                            {
                                filterItems.map((item, index) => {
                                    ...
                                    {
                                        if (item.type == "Personalized Items") {
                                            return (
...
export default PersonalizedItems;
